...
<?php 
  if(isset($_POST['email'])){
	...
	$receiver="abdullah@fisheye.sa";
	$subject="Fisheye website Contact form details";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://fisheye.sa/img/logos2.png' ></td>
	</tr>
	<tr>
...
$headers .= 'From: <'.$from.'>' . "\r\n";
   if(mail($receiver,$subject,$message,$headers))  
   {
      ...
      header( "refresh:1;url=http://fisheye.sa/" );
   }
   else
   {	
   	 //Fail Message
